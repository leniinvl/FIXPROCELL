...
<head>
	...
	<meta name="autor" content="SaleSyst">
	...
	<link rel="icon" type="image/png" href="web/assets/images/click.png"/>
	<link rel="shortcut icon" href="web/assets/images/click.png">
...
<body class="sidebar-xs has-detached-right">
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="./?View=Inicio"><img src="web/assets/images/click_ventas.png" alt=""></a>
			...
			<ul class="nav navbar-nav" >
				<li><a class="sidebar-control sidebar-main-toggle hidden-xs" title="Ocultar Menú"><i class="icon-stack"></i></a></li>
			</ul>
						...
						<div class="category-content">
							<div class="media">
								<div class="media-body">
									<span class="media-heading text-bold"><?php echo $cargo ?></span>
