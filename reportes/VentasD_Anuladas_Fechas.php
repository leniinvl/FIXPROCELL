...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(110,10,'DETALLES DE VENTAS ANULADAS ENTRE EL '.$fecha1.' Y '.$fecha2,0,0,'C');
...
// Page footer
    ...
    $objVenta =  new Venta();
    $listado = $objVenta->Listar_Ventas_Detalle('FECHAS',$fecha1,$fecha2,0,$idsucursal);
    $totales = $objVenta->Listar_Ventas_Totales('FECHAS',$fecha1,$fecha2,0,$idsucursal);
