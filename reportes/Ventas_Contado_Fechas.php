...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(110,10,'VENTAS AL CONTADO ENTRE EL '.$fecha1.' Y '.$fecha2,0,0,'C');
...
try {
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->Text(10,$get_Y + 10,'MONTO TOTAL INGRESADO POR VENTAS ENTRE DICHAS FECHAS : '.number_format($total, 2, '.', ','));
