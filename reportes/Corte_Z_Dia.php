<?php
    ...
    if($fecha == ""){
    	...
    	$detalle = $objVenta->Imprimir_Corte_Z_Dia(date('Y-m-d'),1,$idsucursal);
		$detalle2 = $objVenta->Imprimir_Corte_Z_Dia(date('Y-m-d'),2,$idsucursal);

    } else {

    	$detalle = $objVenta->Imprimir_Corte_Z_Dia($fecha,1,$idsucursal);
		$detalle2 = $objVenta->Imprimir_Corte_Z_Dia($fecha,2,$idsucursal);
