...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(100);
            // Title
            $this->Cell(115,10,'RESUMEN DE SALDOS Y MOVIMIENTOS DE PRODUCTOS DEL MES DE '.strtoupper($meses[date(substr($mes,0,2))-1].' del '.$ano),0,0,'C');
...
// Page footer
    ...
    $listado = $objInventario->Listar_Kardex($mes,$idsucursal);
