...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(110,10,'VENTAS ANULADAS DEL MES '.strtoupper($meses[date(substr($mes,0,2))-1].' del '.$ano),0,0,'C');
...
try {
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->Text(10,$get_Y + 10,'VALOR TOTAL EN VENTAS ANULADAS ESTE MES : '.number_format($total, 2, '.', ','));
