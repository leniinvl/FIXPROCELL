...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105,10,'APARTADOS VIGENTES ENTRE EL '.$fecha1.' Y '.$fecha2,0,0,'C');
...
// Page footer
    ...
    $listado = $objApartado->Listar_Apartados('FECHAS',$fecha1,$fecha2,1);
...
try {
    ...
    $pdf->Output('I','Apartados_Vigentes_del_'.$fecha1.'_al_'.$fecha2.'.pdf');
