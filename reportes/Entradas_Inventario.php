...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(103);
            // Title
            $this->Cell(105,10,'ENTRADAS DE PRODUCTOS DEL MES DE '.strtoupper($meses[date(substr($mes,0,2))-1].' del '.$ano),0,0,'C');
...
// Page footer
    ...
    $listado = $objInventario->Listar_Entradas($mes, $idsucursal);
