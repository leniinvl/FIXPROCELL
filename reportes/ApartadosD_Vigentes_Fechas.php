...
// Page footer
    ...
    $listado = $objApartado->Listar_Apartados_Detalle('FECHAS',$fecha1,$fecha2,1);
    $totales = $objApartado->Listar_Apartados_Totales('FECHAS',$fecha1,$fecha2,1);
...
// Instanciation of inherited class
    ...
    $pdf->Output('I','ApartadosD_Vigentes_del_'.$fecha1.'_al_'.$fecha2.'.pdf');
