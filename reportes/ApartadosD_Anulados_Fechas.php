...
// Page footer
    ...
    $listado = $objApartado->Listar_Apartados_Detalle('FECHAS',$fecha1,$fecha2,0);
    $totales = $objApartado->Listar_Apartados_Totales('FECHAS',$fecha1,$fecha2,0);
...
try {
    ...
    $pdf->Output('I','ApartadosD_Anulados_del_'.$fecha1.'_al_'.$fecha2.'.pdf');
