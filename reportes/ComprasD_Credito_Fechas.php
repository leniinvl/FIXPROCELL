...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(98);
            // Title
            $this->Cell(115,10,'COMPRAS (DETALLADAS) AL CREDITO ENTRE EL '.$fecha1.' Y '.$fecha2,0,0,'C');
...
// Page footer
    ...
    $listado = $objCompra->Listar_Compras_Detalle('FECHAS',$fecha1,$fecha2,'',2);
    $totales = $objCompra->Listar_Compras_Totales('FECHAS',$fecha1,$fecha2,'',2);
