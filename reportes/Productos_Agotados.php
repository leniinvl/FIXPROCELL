...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105);
            // Title
            $this->Cell(105,10,'Reporte de productos agotados en almacen',0,0,'C');
...
// Page footer
    ...
    $listado = $objProducto->Listar_Productos_Agotados($idsucursal, $idcategoria);
...
try {
    ...
    $pdf->Output('I','Productos_Agotados.pdf',true);
