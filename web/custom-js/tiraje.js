...
function newTiraje()
 {
    openTiraje('nuevo',null,null,null,null,null,null,null,null,null,null);
    $('#modal_iconified').modal('show');
 }
function openTiraje(action, idtiraje, fecha_resolucion, numero_resolucion, clave, serie, desde, hasta, disponibles, usados, idcomprobante)
 {
...
function enviar_frm()
{
  ...
  var usados =$("#txtUsados").val();
  var idcomprobante =$("#cbCompro").val();
      disponibles = hasta - usados;
  
  var dataString='proceso='+proceso+'&id='+id+'&fecha_resolucion='+fecha_resolucion+'&numero_resolucion='+numero_resolucion+'&clave='+clave+'&serie='+serie;
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              swal({
                  title: "Exito!",
                  timer: 1000,
                  text: "Numeracion y serie registrado",
              ...
              limpiarform();
                  ...
                  swal({
                      title: "Exito!",
                      timer: 1000,
                      text: "Numeracion y serie modificado",
