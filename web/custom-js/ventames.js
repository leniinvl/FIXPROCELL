 ...
 var mes = $("#txtMes").val();
    ...
    if(mes!="")
    {
        $.ajax({
           ...
           type:"GET",
           url:"web/ajax/reload-ventas_mes.php?mes="+mes,
           ...
           type:"GET",
           url:"web/ajax/reload-ventas_mes.php?mes=empty",
           success: function(data){
              $('#reload-div').html(data);
           }
 ...
 function Print_Report(Criterio)
{
  ...
  if(estado == 0){
    ...
    if(mes!="")
    {
        ...
        {
             window.open('reportes/Ventas_Vigentes_Mes.php?mes='+mes,
            'win2',
            ...
            'fullscreen=yes');
             ...
             window.open('reportes/Ventas_Anuladas_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/Ventas_Contado_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/Ventas_Credito_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
    ...
    if(mes!="")
    {
        if(Criterio == 'Vigentes')
        {
             window.open('reportes/VentasD_Vigentes_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=800,height=800,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/VentasD_Anuladas_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/VentasD_Contado_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/VentasD_Credito_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
