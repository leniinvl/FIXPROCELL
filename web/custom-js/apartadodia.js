...
function buscar_datos()
{
    $.ajax({
       ...
       type:"GET",
       url:"web/ajax/reload-apartados_dia.php",
       success: function(data){
...
function Print_Report(Criterio)
{
  ...
  if(estado == 0){
    ...
    {
         window.open('reportes/Apartados_Vigentes_Dia.php',
        'win2',
        ...
        'fullscreen=yes');
         ...
         window.open('reportes/Apartados_Anulados_Dia.php',
        'win2',
        'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
        'resizable=yes,width=600,height=600,directories=no,location=no'+
        'fullscreen=yes');
         ...
         window.open('reportes/Apartados_Finalizados_Dia.php',
        'win2',
        'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
        'resizable=yes,width=600,height=600,directories=no,location=no'+
        'fullscreen=yes');
    ...
    if(Criterio == 'Vigentes')
    {
         window.open('reportes/ApartadosD_Vigentes_Dia.php',
        'win2',
        'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
        'resizable=yes,width=800,height=800,directories=no,location=no'+
        'fullscreen=yes');
         ...
         window.open('reportes/ApartadosD_Anulados_Dia.php',
        'win2',
        'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
        'resizable=yes,width=600,height=600,directories=no,location=no'+
        'fullscreen=yes');
         ...
         window.open('reportes/ApartadosD_Finalizados_Dia.php',
        'win2',
        'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
        'resizable=yes,width=600,height=600,directories=no,location=no'+
        'fullscreen=yes');
