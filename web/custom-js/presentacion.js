...
function enviar_frm()
{
  ...
  var dataString='proceso='+proceso+'&id='+id+'&presentacion='+sigla+'&sigla='+sigla+'&estado='+estado;
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              swal({
                  title: "Exito!",
                  timer: 1000,
                  text: "Modelo registrada correctamente",
              ...
              limpiarform();
                  ...
                  swal({
                      title: "Exito!",
                      timer: 1000,
                      text: "Modelo modificada correctamente",
