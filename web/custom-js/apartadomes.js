 ...
 var mes = $("#txtMes").val();
    ...
    if(mes!="")
    {
        $.ajax({
           ...
           type:"GET",
           url:"web/ajax/reload-apartados_mes.php?mes="+mes,
           success: function(data){
           ...
           type:"GET",
           url:"web/ajax/reload-apartados_mes.php?mes=empty",
           success: function(data){
              $('#reload-div').html(data);
           }
 ...
 function Print_Report(Criterio)
{
  ...
  if(estado == 0){
    ...
    if(mes!="")
    {
        ...
        {
             window.open('reportes/Apartados_Vigentes_Mes.php?mes='+mes,
            'win2',
            ...
            'fullscreen=yes');
             ...
             window.open('reportes/Apartados_Anulados_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/Apartados_Finalizados_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
    ...
    if(mes!="")
    {
        ...
        if(Criterio == 'Vigentes')
        {
             window.open('reportes/ApartadosD_Vigentes_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=800,height=800,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/ApartadosD_Anulados_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
             ...
             window.open('reportes/ApartadosD_Finalizados_Mes.php?mes='+mes,
            'win2',
            'status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes,'+
            'resizable=yes,width=600,height=600,directories=no,location=no'+
            'fullscreen=yes');
