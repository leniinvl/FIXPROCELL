...
function agergar_detalle(idproducto,producto,datos,precio_compra,cantidad,exento,perecedero){
    ...
    //Autocomplete
   var idSucursal = $("#idSucursalCompra").val();
   $("#buscar_producto").autocomplete({
        minLength: 1,
        source: "web/ajax/autocomplete_producto.php?id="+idSucursal,
          ...
          $("#tbldetalle tbody tr").each(function (index)
              {
                ...
                if(true){
                    ...
                    tarifa_iva = (tarifa_iva + sumas - exentos);
                    total_sumas = tarifa_iva / iva_div; //new
