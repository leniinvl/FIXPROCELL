$(function() {
  ...
  $(document).on('click', '#print_color', function(e){
    ...
    }, "No se permiten caracteres numéricos");
...
function newColor()
 {
    openColor('nuevo',null,null);
    $('#modal_iconified').modal('show');
 }
function openColor(action,idcolor,nombre_color)
 {
...
function enviar_frm()
{
  var urlprocess = 'web/ajax/ajxcolor.php';
  var proceso = $("#txtProceso").val();
  var id = $("#txtID").val();
  var color =$("#txtColor").val();

  var dataString='proceso='+proceso+'&id='+id+'&color='+color;
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-color.php");
              limpiarform();
                  ...
                  swal({
                      title: "Exito!",
                      timer: 1000,
                      text: "Color modificada correctamente",
...
function Print_Report()
{
   ...
   window.open('reportes/ _Reporte.php',
  'win2',
