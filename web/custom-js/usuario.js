...
function newUsuario()
 {
    openUsuario('nuevo',null,null,null,null,null,null,null,null,null);
...
function openUsuario(action, idusuario, usuario, contrasena, tipo_usuario, estado, idempleado)
 {
    ...
    $('#modal_iconified').on('shown.bs.modal', function () {
     ...
     if (action == 'nuevo'){
      ...
      modal.find('.title-form').text('Ingresar Usuario');
      ...
      modal.find('.title-form').text('Actualizar Usuario');
     } else if(action=='ver'){
      $('#txtProceso').val('');
      $('#txtID').val(idusuario);
      $('#txtUser').val(usuario);
      ...
      modal.find('.title-form').text('Ver Usuario');
     }
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-usuario.php");
              limpiarform();
           ...
           swal({
               ...
               swal({
                title: "Lo sentimos, valide su password...",
