<?php
	...
	$objVenta =  new Venta();
	$count_ventas = $objVenta->Count_Ventas('FECHAS',$fecha1,$fecha2,$idsucursal);
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('FECHAS',$fecha1,$fecha2,1,$idsucursal);
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('FECHAS',$fecha1,$fecha2,0,$idsucursal);
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column)
										{
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('FECHAS',$fecha1,$fecha2,2,$idsucursal);
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column)
										{
