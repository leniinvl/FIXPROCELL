				...
				<div class="panel-body">
					<div class="table-responsive">
						...
						<tr>
							...
							<td width="2%" class="text-bold text-left">C.I./RUC</td>
						...
						<tr>
							...
							<td width="5%"><?php if($tipo_comprobante == "1"){ echo "RECIBO"; }elseif ($tipo_comprobante=="2") {echo "FACTURA";}
			...
			<table id="tbldetalle" class="table table-borderless table-striped table-xxs">
				...
				<tbody>
				 ...
				 <?php
					...
					?>
						<tr>
		                	<td><?php print($column['nombre_producto']." ".$column['nombre_marca']." ".$column['siglas']); ?></td>
				...
				<tfoot>
					<tr>
						...
						<td></td>
						<td></td>
						<td width="15%">TARIFA <?php echo $textoPorcetajeIVA?></td>
					...
					<tr>
						...
						<td></td>
						<td></td>
						<td width="15%">IVA <?php echo $textoPorcetajeIVA?></td>
