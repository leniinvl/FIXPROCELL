...
spl_autoload_register(function($className){
	...
	$objVenta =  new Venta();
	$count_ventas = $objVenta->Count_Ventas('HOY','','',$idsucursal);
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('HOY','','',1,$idsucursal);
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('HOY','','',0,$idsucursal);
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column)
										{
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('HOY','','',2,$idsucursal);
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column)
										{
