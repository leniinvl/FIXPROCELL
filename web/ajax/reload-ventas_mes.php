<?php
	...
	$objVenta =  new Venta();
	$count_ventas = $objVenta->Count_Ventas('MES',$mes,'','');
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('MES',$mes,'',1,'');
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('MES',$mes,'',0,'');
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column)
										{
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php
										$filas = $objVenta->Listar_Ventas('MES',$mes,'',2,'');
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column)
										{
