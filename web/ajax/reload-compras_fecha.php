				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						...
						<div class="heading-elements">
							<button type="button" id="print_vigentes"  class="btn bg-info-800 heading-btn" id="btnPrint" value="vigentes">
			...
			<div class="tab-pane" id="label-tab2">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						...
						<div class="heading-elements">
							<button type="button" id="print_anuladas" class="btn bg-info-800 heading-btn" id="btnPrint" value="anuladas">
							<i class="icon-printer2"></i> Imprimir Reporte</button>
						</div>
					</div>
						<div class="panel-body">
