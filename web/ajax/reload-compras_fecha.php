<?php 
	...
	$count_compras = $objCompra->Count_Compras('FECHAS',$fecha1,$fecha2,$idsucursal);
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						...
						<div class="heading-elements">
							<button type="button" id="print_vigentes"  class="btn bg-danger-400 heading-btn" id="btnPrint" value="vigentes">
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php 
										$filas = $objCompra->Listar_Compras('FECHAS',$fecha1,$fecha2,1,'',$idsucursal); 
			...
			<div class="tab-pane" id="label-tab2">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						...
						<div class="heading-elements">
							<button type="button" id="print_anuladas" class="btn bg-danger-400 heading-btn" id="btnPrint" value="anuladas">
							<i class="icon-printer2"></i> Imprimir Reporte</button>
						</div>
					</div>
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php 
										$filas = $objCompra->Listar_Compras('FECHAS',$fecha1,$fecha2,0,'',$idsucursal); 
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column) 
										{
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php 
										$filas = $objCompra->Listar_Compras('FECHAS',$fecha1,$fecha2,'',2,$idsucursal); 
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column) 
										{
