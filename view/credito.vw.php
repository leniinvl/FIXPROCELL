					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li><a href="javascript:;">Créditos</a></li>
								<li class="active">Administrar Crédito</li>
							</ul>
						</div>
						<div class="panel-heading">
							<h5 class="panel-title"><b>Administración de Créditos</b></h5>
						</div>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="input-group">
										<span class="input-group-addon"><i class="icon-calendar3"></i></span>
										<input type="text" id="txtFechaA" name="txtFechaA" placeholder="<?php echo (date("d/m/Y")); ?>"
										 class="form-control" style="text-transform:uppercase;"
										onkeyup="javascript:this.value=this.value.toUpperCase();">
										</div>
									</div>
	...
	<div class="modal-content">
		...
		<div class="modal-body">
				...
				<div class="col-md-12">
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h6 class="panel-title">TICKET</h6>
						</div>
						<div class="panel-body">
