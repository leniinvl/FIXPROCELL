									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												<input type="text" id="txtApellido" name="txtApellido" placeholder="EJ. FIGUEROA"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtTelefono" name="txtTelefono" placeholder="EJ. 051944039644"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
											...
											<div class="col-sm-6">
												<label>Email</label>
												<input type="email" id="txtEmail" name="txtEmail" placeholder="EJ. juan@miempresa.com"
												 class="form-control">
											</div>
