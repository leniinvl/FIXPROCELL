					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li class="active">Apartados por Fechas</li>
							</ul>
						</div>
						<div class="panel-heading">
							<h6 class="panel-title">Apartados por Fechas</h6>
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
															...
															<?php
																$filas = $objApartado->Listar_Apartados('FECHAS','','',1);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
									...
									<div class="tab-pane" id="label-tab2">
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												...
												<div class="heading-elements">
													<button type="button" id="print_ANULADOs"
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
															...
															<?php
																$filas = $objApartado->Listar_Apartados('FECHAS','','',0);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
															...
															<?php
																$filas = $objApartado->Listar_Apartados('FECHAS','','',2);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
	...
	<div id="modal_detalle" class="modal fade">
		<div class="modal-dialog modal-full">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h5 class="modal-title"></i> &nbsp; <span class="title-form text-uppercase">Detalle de Apartado</span></h5>
				</div>
...
<script type="text/javascript" src="web/custom-js/apartadofechas.js"></script>
