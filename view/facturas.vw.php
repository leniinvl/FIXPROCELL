<?php
	...
	$objVenta =  new Venta();
	$count_ventas = $objVenta->Count_Facturas('FECHAS','','',$idsucursal);
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Facturas('FECHAS','','',1,$idsucursal);
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Facturas('FECHAS','','',0,$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
