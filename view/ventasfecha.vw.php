<?php
	...
	$objVenta =  new Venta();
	$count_ventas = $objVenta->Count_Ventas('FECHAS','','',$idsucursal);
				...
				<div class="col-lg-12">
					<div class="panel panel-flat">
						...
						<div class="panel-heading">
							<h6 class="panel-title"><b>Ventas por Fechas</b></h6>
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Ventas('FECHAS','','',1,$idsucursal);
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Ventas('FECHAS','','',0,$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Ventas('FECHAS','','',2,$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
