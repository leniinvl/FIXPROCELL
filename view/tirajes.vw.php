			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Numeración-Serie</li>
					</ul>
				</div>
					        ...
					        <form role="form" autocomplete="off" class="form-validate-jquery" id="frmModal">
		                     ...
		                     onkeyup="javascript:this.value=this.value.toUpperCase();">
						 			...
						 			<div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												...
												<input type="text" id="txtNoResolucion" name="txtNoResolucion" placeholder="30202-RES-CR-38701-2015"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-12">
												...
												<input type="text" id="txtClave" name="txtClave" placeholder=""
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();"
                                        		disabled="disabled">
											</div>
						           ...
						           <div class="form-group">
										<div class="row">
											<div class="col-sm-6">
												<label>Numeracion Del <span class="text-danger">*</span></label>
											...
											<div class="col-sm-6">
												<label>Al <span class="text-danger">*</span></label>
												<input type="text" id="txtAl" name="txtAl" placeholder="1000"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
						           ...
						           <div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6">
												<label>Numeracion actual <span class="text-danger">*</span></label>
