					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li class="active">Apartados del Dia</li>
							</ul>
						</div>
						<div class="panel-heading">
							<h6 class="panel-title">Apartados del Dia - <?php echo
...
<!-- Iconified modal -->
										...
										<div class="panel-body">
											<div class="table-responsive">
												...
												<tr>
													...
													<td width="30%"></td>
													<td width="2%" class="text-bold text-left">FECHA APARTADO</td>
													<td width="30%"></td>
												</tr>
												<tr>
	...
	<script type="text/javascript" src="web/custom-js/apartadodia.js"></script>
