<?php
	...
	$count_compras = $objCompra->Count_Compras('MES','','',$idsucursal);
					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li class="active">Compras del Mes</li>
							</ul>
						</div>
						<div class="panel-heading">
							<h6 class="panel-title"><b>Compras del Mes</b></h6>
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objCompra->Listar_Compras('MES','','',1,'',$idsucursal);
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objCompra->Listar_Compras('MES','','',0,'',$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objCompra->Listar_Compras('MES','','','',2,$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
