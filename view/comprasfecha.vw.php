												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objCompra->Listar_Compras('FECHAS','','',1,'',$idsucursal);
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objCompra->Listar_Compras('FECHAS','','',0,'',$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objCompra->Listar_Compras('FECHAS','','','',2,$idsucursal);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
