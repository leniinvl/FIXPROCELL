<?php
	...
	class Taller {
		...
		public static function Listar_Ordenes($date,$date2,$idsucursal){

			$filas = TallerModel::Listar_Ordenes($date,$date2,$idsucursal);
			return $filas;
		...
		public static function Count_Ordenes($date,$date2,$idsucursal){

			$filas = TallerModel::Count_Ordenes($date,$date2,$idsucursal);
			return $filas;

		}

		public static function Insertar_Orden($idcliente,$aparato,$modelo,$idmarca,$serie,$idtecnico,$averia,
		$observaciones,$deposito_revision,$deposito_reparacion,$parcial_pagar,$idsucursal){
