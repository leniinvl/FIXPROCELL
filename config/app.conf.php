<?php
    ...
    $conf["Ventas-Productos"] = array(
        "file" => "ventasproducto.vw.php"
    );
    ...
    $conf["Asistencia-reporte"] = array(
        "file" => "asistenciareporte.vw.php"
    );

    $conf["Asistencia-registro"] = array(
        "file" => "asistenciaregistro.vw.php"
    );
    ...
    //Cuentas
    $conf["Consulta-factura"] = array(
        "file" => "facturas.vw.php"
    );
    //Cuentas
