<?php 
	...
	class TirajeModel extends Conexion
	{
		...
		public static function Insertar_Tiraje($fecha_resolucion, $numero_resolucion, $clave, $serie, $desde, $hasta, $disponibles, $idcomprobante)
		{
			...
			try 
			{
				$query = "CALL sp_insert_tiraje_comprobante(:fecha_resolucion, :numero_resolucion, :serie, :desde, :hasta, :disponibles, :idcomprobante, :clave)";
				$stmt = $dbconec->prepare($query);
		...
		public static function Editar_Tiraje($idtiraje, $fecha_resolucion, $numero_resolucion, $clave, $serie, $desde, $hasta, $disponibles, $idcomprobante)
		{
			...
			try 
			{
				...
				:numero_resolucion, :serie, :desde, :hasta,  :disponibles, :idcomprobante, :clave)";
				$stmt = $dbconec->prepare($query);
